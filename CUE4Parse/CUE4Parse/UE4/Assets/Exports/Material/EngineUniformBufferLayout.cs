...
public static class EngineUniformBufferLayout
{
    ...
    /// <summary>
    /// Same idea as <see cref="ViewRows"/>/<see cref="PrimitiveRows"/> above, but derived from the
    /// real UE_4.19 struct declarations instead of a later engine's - confirmed genuinely different
    /// layouts, not just a hunch: 4.19's FViewUniformShaderParameters
    /// (Engine/Public/SceneView.h:602-737) has no "ClipToWorld" matrix at all (added later, sitting
    /// right after WorldToClip in the vanilla table above - the single biggest source of wrong-field
    /// results reported against 1.10 cooks, since it shifts every field below it by a whole 4-row
    /// matrix) and is missing two scalars present later ("DeltaTime" and "StateFrameIndex", each
    /// shifting everything below by one more row once packed in with their neighboring scalars).
    /// FPrimitiveUniformShaderParameters (Engine/Public/PrimitiveUniformShaderParameters.h:14-33) is
    /// smaller still: no motion-vector fields (PreviousLocalToWorld/PreviousWorldToLocal - TAA-era
    /// additions), no LightmapDataIndex/SingleCaptureIndex, and InvNonUniformScale is its own field
    /// rather than being combined with LocalToWorldDeterminantSign into one
    /// "InvNonUniformScaleAndDeterminantSign" vector the way the later struct packs it.
    ///
    /// Every row below was computed the same mechanical way as the vanilla tables (see this class's
    /// own header comment for the alignment rules), walking the two structs' 4.19 field declaration
    /// order field-by-field - not measured from one compiled shader, so it applies to every UE4_19
    /// material, at any feature level (unlike the vanilla table's SM5-only restriction, the same
    /// fixed C++ struct is used regardless of feature level within a single engine build, so there is
    /// no SM4-vs-SM5 ambiguity here the way there is for the later engine's table above).
    /// </summary>
    public static readonly Dictionary<int, string?[]> ViewRowsUE4_19 = new()
    {
        [0] = new string?[] { "TranslatedWorldToClip", "TranslatedWorldToClip", "TranslatedWorldToClip", "TranslatedWorldToClip" },
        [1] = new string?[] { "TranslatedWorldToClip", "TranslatedWorldToClip", "TranslatedWorldToClip", "TranslatedWorldToClip" },
        [2] = new string?[] { "TranslatedWorldToClip", "TranslatedWorldToClip", "TranslatedWorldToClip", "TranslatedWorldToClip" },
        ...
        [6] = new string?[] { "WorldToClip", "WorldToClip", "WorldToClip", "WorldToClip" },
        [7] = new string?[] { "WorldToClip", "WorldToClip", "WorldToClip", "WorldToClip" },
        [8] = new string?[] { "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView" },
        [9] = new string?[] { "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView" },
        [10] = new string?[] { "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView" },
        [11] = new string?[] { "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView", "TranslatedWorldToView" },
        [12] = new string?[] { "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld" },
        [13] = new string?[] { "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld" },
        [14] = new string?[] { "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld" },
        [15] = new string?[] { "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld", "ViewToTranslatedWorld" },
        [16] = new string?[] { "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView" },
        [17] = new string?[] { "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView" },
        [18] = new string?[] { "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView" },
        [19] = new string?[] { "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView", "TranslatedWorldToCameraView" },
        [20] = new string?[] { "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld" },
        [21] = new string?[] { "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld" },
        [22] = new string?[] { "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld" },
        [23] = new string?[] { "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld", "CameraViewToTranslatedWorld" },
        [24] = new string?[] { "ViewToClip", "ViewToClip", "ViewToClip", "ViewToClip" },
        [25] = new string?[] { "ViewToClip", "ViewToClip", "ViewToClip", "ViewToClip" },
        [26] = new string?[] { "ViewToClip", "ViewToClip", "ViewToClip", "ViewToClip" },
        [27] = new string?[] { "ViewToClip", "ViewToClip", "ViewToClip", "ViewToClip" },
        [28] = new string?[] { "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA" },
        [29] = new string?[] { "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA" },
        [30] = new string?[] { "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA" },
        [31] = new string?[] { "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA", "ViewToClipNoAA" },
        [32] = new string?[] { "ClipToView", "ClipToView", "ClipToView", "ClipToView" },
        [33] = new string?[] { "ClipToView", "ClipToView", "ClipToView", "ClipToView" },
        [34] = new string?[] { "ClipToView", "ClipToView", "ClipToView", "ClipToView" },
        [35] = new string?[] { "ClipToView", "ClipToView", "ClipToView", "ClipToView" },
        [36] = new string?[] { "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld" },
        [37] = new string?[] { "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld" },
        [38] = new string?[] { "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld" },
        [39] = new string?[] { "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld", "ClipToTranslatedWorld" },
        [40] = new string?[] { "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld" },
        [41] = new string?[] { "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld" },
        [42] = new string?[] { "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld" },
        [43] = new string?[] { "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld", "SVPositionToTranslatedWorld" },
        [44] = new string?[] { "ScreenToWorld", "ScreenToWorld", "ScreenToWorld", "ScreenToWorld" },
        [45] = new string?[] { "ScreenToWorld", "ScreenToWorld", "ScreenToWorld", "ScreenToWorld" },
        [46] = new string?[] { "ScreenToWorld", "ScreenToWorld", "ScreenToWorld", "ScreenToWorld" },
        [47] = new string?[] { "ScreenToWorld", "ScreenToWorld", "ScreenToWorld", "ScreenToWorld" },
        [48] = new string?[] { "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld" },
        [49] = new string?[] { "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld" },
        [50] = new string?[] { "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld" },
        [51] = new string?[] { "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld", "ScreenToTranslatedWorld" },
        [52] = new string?[] { "ViewForward", "ViewForward", "ViewForward", null },
        [53] = new string?[] { "ViewUp", "ViewUp", "ViewUp", null },
        [54] = new string?[] { "ViewRight", "ViewRight", "ViewRight", null },
        [55] = new string?[] { "HMDViewNoRollUp", "HMDViewNoRollUp", "HMDViewNoRollUp", null },
        [56] = new string?[] { "HMDViewNoRollRight", "HMDViewNoRollRight", "HMDViewNoRollRight", null },
        [57] = new string?[] { "InvDeviceZToWorldZTransform", "InvDeviceZToWorldZTransform", "InvDeviceZToWorldZTransform", "InvDeviceZToWorldZTransform" },
        [58] = new string?[] { "ScreenPositionScaleBias", "ScreenPositionScaleBias", "ScreenPositionScaleBias", "ScreenPositionScaleBias" },
        [59] = new string?[] { "WorldCameraOrigin", "WorldCameraOrigin", "WorldCameraOrigin", null },
        [60] = new string?[] { "TranslatedWorldCameraOrigin", "TranslatedWorldCameraOrigin", "TranslatedWorldCameraOrigin", null },
        [61] = new string?[] { "WorldViewOrigin", "WorldViewOrigin", "WorldViewOrigin", null },
        [62] = new string?[] { "PreViewTranslation", "PreViewTranslation", "PreViewTranslation", null },
        [63] = new string?[] { "PrevProjection", "PrevProjection", "PrevProjection", "PrevProjection" },
        [64] = new string?[] { "PrevProjection", "PrevProjection", "PrevProjection", "PrevProjection" },
        [65] = new string?[] { "PrevProjection", "PrevProjection", "PrevProjection", "PrevProjection" },
        [66] = new string?[] { "PrevProjection", "PrevProjection", "PrevProjection", "PrevProjection" },
        [67] = new string?[] { "PrevViewProj", "PrevViewProj", "PrevViewProj", "PrevViewProj" },
        [68] = new string?[] { "PrevViewProj", "PrevViewProj", "PrevViewProj", "PrevViewProj" },
        [69] = new string?[] { "PrevViewProj", "PrevViewProj", "PrevViewProj", "PrevViewProj" },
        [70] = new string?[] { "PrevViewProj", "PrevViewProj", "PrevViewProj", "PrevViewProj" },
        [71] = new string?[] { "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj" },
        [72] = new string?[] { "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj" },
        [73] = new string?[] { "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj" },
        [74] = new string?[] { "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj", "PrevViewRotationProj" },
        [75] = new string?[] { "PrevViewToClip", "PrevViewToClip", "PrevViewToClip", "PrevViewToClip" },
        [76] = new string?[] { "PrevViewToClip", "PrevViewToClip", "PrevViewToClip", "PrevViewToClip" },
        [77] = new string?[] { "PrevViewToClip", "PrevViewToClip", "PrevViewToClip", "PrevViewToClip" },
        [78] = new string?[] { "PrevViewToClip", "PrevViewToClip", "PrevViewToClip", "PrevViewToClip" },
        [79] = new string?[] { "PrevClipToView", "PrevClipToView", "PrevClipToView", "PrevClipToView" },
        [80] = new string?[] { "PrevClipToView", "PrevClipToView", "PrevClipToView", "PrevClipToView" },
        [81] = new string?[] { "PrevClipToView", "PrevClipToView", "PrevClipToView", "PrevClipToView" },
        [82] = new string?[] { "PrevClipToView", "PrevClipToView", "PrevClipToView", "PrevClipToView" },
        [83] = new string?[] { "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip" },
        [84] = new string?[] { "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip" },
        [85] = new string?[] { "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip" },
        [86] = new string?[] { "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip", "PrevTranslatedWorldToClip" },
        [87] = new string?[] { "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView" },
        [88] = new string?[] { "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView" },
        [89] = new string?[] { "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView" },
        [90] = new string?[] { "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView", "PrevTranslatedWorldToView" },
        [91] = new string?[] { "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld" },
        [92] = new string?[] { "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld" },
        [93] = new string?[] { "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld" },
        [94] = new string?[] { "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld", "PrevViewToTranslatedWorld" },
        [95] = new string?[] { "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView" },
        [96] = new string?[] { "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView" },
        [97] = new string?[] { "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView" },
        [98] = new string?[] { "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView", "PrevTranslatedWorldToCameraView" },
        [99] = new string?[] { "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld" },
        [100] = new string?[] { "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld" },
        [101] = new string?[] { "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld" },
        [102] = new string?[] { "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld", "PrevCameraViewToTranslatedWorld" },
        [103] = new string?[] { "PrevWorldCameraOrigin", "PrevWorldCameraOrigin", "PrevWorldCameraOrigin", null },
        [104] = new string?[] { "PrevWorldViewOrigin", "PrevWorldViewOrigin", "PrevWorldViewOrigin", null },
        [105] = new string?[] { "PrevPreViewTranslation", "PrevPreViewTranslation", "PrevPreViewTranslation", null },
        [106] = new string?[] { "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj" },
        [107] = new string?[] { "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj" },
        [108] = new string?[] { "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj" },
        [109] = new string?[] { "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj", "PrevInvViewProj" },
        [110] = new string?[] { "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld" },
        [111] = new string?[] { "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld" },
        [112] = new string?[] { "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld" },
        [113] = new string?[] { "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld", "PrevScreenToTranslatedWorld" },
        [114] = new string?[] { "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip" },
        [115] = new string?[] { "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip" },
        [116] = new string?[] { "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip" },
        [117] = new string?[] { "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip", "ClipToPrevClip" },
        [118] = new string?[] { "TemporalAAJitter", "TemporalAAJitter", "TemporalAAJitter", "TemporalAAJitter" },
        [119] = new string?[] { "GlobalClippingPlane", "GlobalClippingPlane", "GlobalClippingPlane", "GlobalClippingPlane" },
        [120] = new string?[] { "FieldOfViewWideAngles", "FieldOfViewWideAngles", "PrevFieldOfViewWideAngles", "PrevFieldOfViewWideAngles" },
        [121] = new string?[] { "ViewRectMin", "ViewRectMin", "ViewRectMin", "ViewRectMin" },
        [122] = new string?[] { "ViewSizeAndInvSize", "ViewSizeAndInvSize", "ViewSizeAndInvSize", "ViewSizeAndInvSize" },
        [123] = new string?[] { "BufferSizeAndInvSize", "BufferSizeAndInvSize", "BufferSizeAndInvSize", "BufferSizeAndInvSize" },
        [124] = new string?[] { "BufferBilinearUVMinMax", "BufferBilinearUVMinMax", "BufferBilinearUVMinMax", "BufferBilinearUVMinMax" },
        [125] = new string?[] { "NumSceneColorMSAASamples", "PreExposure", "OneOverPreExposure", null },
        [126] = new string?[] { "DiffuseOverrideParameter", "DiffuseOverrideParameter", "DiffuseOverrideParameter", "DiffuseOverrideParameter" },
        [127] = new string?[] { "SpecularOverrideParameter", "SpecularOverrideParameter", "SpecularOverrideParameter", "SpecularOverrideParameter" },
        [128] = new string?[] { "NormalOverrideParameter", "NormalOverrideParameter", "NormalOverrideParameter", "NormalOverrideParameter" },
        [129] = new string?[] { "RoughnessOverrideParameter", "RoughnessOverrideParameter", "PrevFrameGameTime", "PrevFrameRealTime" },
        // NOTE: the vanilla 4.19 engine has an "OutOfBoundsMask" float here (SceneView.h:660) between
        // RoughnessOverrideParameter/PrevFrame* above and WorldCameraMovementSinceLastFrame below - but
        // Fortnite's branch does not have it. Confirmed empirically: with OutOfBoundsMask omitted (so
        // WorldCameraMovementSinceLastFrame's 16-byte-aligned FVector lands one row earlier, at 130
        // instead of 131), GameTime/RealTime land at row 131, matching a real compiled shader's
        // `cb0[131].z` read of an animated-scroll "Time" value (see PixelShaderDecompiler's row131 bug
        // report - "wheres the time variable here"). Do not add OutOfBoundsMask back without new
        // evidence it exists in this branch.
        [130] = new string?[] { "WorldCameraMovementSinceLastFrame", "WorldCameraMovementSinceLastFrame", "WorldCameraMovementSinceLastFrame", "CullingSign" },
        [131] = new string?[] { "NearPlane", "AdaptiveTessellationFactor", "GameTime", "RealTime" },
        [132] = new string?[] { "MaterialTextureMipBias", "MaterialTextureDerivativeMultiply", "Random", "FrameNumber" },
        [133] = new string?[] { "StateFrameIndexMod8", "CameraCut", "UnlitViewmodeMask", null },
        [134] = new string?[] { "DirectionalLightColor", "DirectionalLightColor", "DirectionalLightColor", "DirectionalLightColor" },
        [135] = new string?[] { "DirectionalLightDirection", "DirectionalLightDirection", "DirectionalLightDirection", null },
        [136] = new string?[] { "TranslucencyLightingVolumeMin", "TranslucencyLightingVolumeMin", "TranslucencyLightingVolumeMin", "TranslucencyLightingVolumeMin" },
        [137] = new string?[] { "TranslucencyLightingVolumeMin", "TranslucencyLightingVolumeMin", "TranslucencyLightingVolumeMin", "TranslucencyLightingVolumeMin" },
        [138] = new string?[] { "TranslucencyLightingVolumeInvSize", "TranslucencyLightingVolumeInvSize", "TranslucencyLightingVolumeInvSize", "TranslucencyLightingVolumeInvSize" },
        [139] = new string?[] { "TranslucencyLightingVolumeInvSize", "TranslucencyLightingVolumeInvSize", "TranslucencyLightingVolumeInvSize", "TranslucencyLightingVolumeInvSize" },
        [140] = new string?[] { "TemporalAAParams", "TemporalAAParams", "TemporalAAParams", "TemporalAAParams" },
        [141] = new string?[] { "CircleDOFParams", "CircleDOFParams", "CircleDOFParams", "CircleDOFParams" },
        [142] = new string?[] { "DepthOfFieldSensorWidth", "DepthOfFieldFocalDistance", "DepthOfFieldScale", "DepthOfFieldFocalLength" },
        [143] = new string?[] { "DepthOfFieldFocalRegion", "DepthOfFieldNearTransitionRegion", "DepthOfFieldFarTransitionRegion", "MotionBlurNormalizedToPixel" },
        [144] = new string?[] { "bSubsurfacePostprocessEnabled", "GeneralPurposeTweak", "DemosaicVposOffset", null },
        [145] = new string?[] { "IndirectLightingColorScale", "IndirectLightingColorScale", "IndirectLightingColorScale", "HDR32bppEncodingMode" },
        [146] = new string?[] { "AtmosphericFogSunDirection", "AtmosphericFogSunDirection", "AtmosphericFogSunDirection", "AtmosphericFogSunPower" },
        [147] = new string?[] { "AtmosphericFogPower", "AtmosphericFogDensityScale", "AtmosphericFogDensityOffset", "AtmosphericFogGroundOffset" },
        [148] = new string?[] { "AtmosphericFogDistanceScale", "AtmosphericFogAltitudeScale", "AtmosphericFogHeightScaleRayleigh", "AtmosphericFogStartDistance" },
        [149] = new string?[] { "AtmosphericFogDistanceOffset", "AtmosphericFogSunDiscScale", "AtmosphericFogRenderMask", "AtmosphericFogInscatterAltitudeSampleNum" },
        [150] = new string?[] { "AtmosphericFogSunColor", "AtmosphericFogSunColor", "AtmosphericFogSunColor", "AtmosphericFogSunColor" },
        [151] = new string?[] { "NormalCurvatureToRoughnessScaleBias", "NormalCurvatureToRoughnessScaleBias", "NormalCurvatureToRoughnessScaleBias", "RenderingReflectionCaptureMask" },
        [152] = new string?[] { "AmbientCubemapTint", "AmbientCubemapTint", "AmbientCubemapTint", "AmbientCubemapTint" },
        [153] = new string?[] { "AmbientCubemapIntensity", "SkyLightParameters", null, null },
        [154] = new string?[] { "SkyLightColor", "SkyLightColor", "SkyLightColor", "SkyLightColor" },
        [155] = new string?[] { "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap" },
        [156] = new string?[] { "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap" },
        [157] = new string?[] { "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap" },
        [158] = new string?[] { "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap" },
        [159] = new string?[] { "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap" },
        [160] = new string?[] { "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap", "SkyIrradianceEnvironmentMap" },
        [161] = new string?[] { "MobilePreviewMode", "HMDEyePaddingOffset", "ReflectionCubemapMaxMip", "ShowDecalsMask" },
        [162] = new string?[] { "DistanceFieldAOSpecularOcclusionMode", "IndirectCapsuleSelfShadowingIntensity", null, null },
        [163] = new string?[] { "ReflectionEnvironmentRoughnessMixingScaleBiasAndLargestWeight", "ReflectionEnvironmentRoughnessMixingScaleBiasAndLargestWeight", "ReflectionEnvironmentRoughnessMixingScaleBiasAndLargestWeight", "StereoPassIndex" },
        [164] = new string?[] { "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB" },
        [165] = new string?[] { "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB" },
        [166] = new string?[] { "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB" },
        [167] = new string?[] { "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB", "GlobalVolumeCenterAndExtent_UB" },
        [168] = new string?[] { "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB" },
        [169] = new string?[] { "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB" },
        [170] = new string?[] { "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB" },
        [171] = new string?[] { "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB", "GlobalVolumeWorldToUVAddAndMul_UB" },
        [172] = new string?[] { "GlobalVolumeDimension_UB", "GlobalVolumeTexelSize_UB", "MaxGlobalDistance_UB", "bCheckerboardSubsurfaceProfileRendering" },
        [173] = new string?[] { "VolumetricFogInvGridSize", "VolumetricFogInvGridSize", "VolumetricFogInvGridSize", null },
        [174] = new string?[] { "VolumetricFogGridZParams", "VolumetricFogGridZParams", "VolumetricFogGridZParams", null },
        [175] = new string?[] { "VolumetricFogSVPosToVolumeUV", "VolumetricFogSVPosToVolumeUV", "VolumetricFogMaxDistance", null },
        [176] = new string?[] { "VolumetricLightmapWorldToUVScale", "VolumetricLightmapWorldToUVScale", "VolumetricLightmapWorldToUVScale", null },
        [177] = new string?[] { "VolumetricLightmapWorldToUVAdd", "VolumetricLightmapWorldToUVAdd", "VolumetricLightmapWorldToUVAdd", null },
        [178] = new string?[] { "VolumetricLightmapIndirectionTextureSize", "VolumetricLightmapIndirectionTextureSize", "VolumetricLightmapIndirectionTextureSize", "VolumetricLightmapBrickSize" },
        [179] = new string?[] { "VolumetricLightmapBrickTexelSize", "VolumetricLightmapBrickTexelSize", "VolumetricLightmapBrickTexelSize", null },
    };

    /// <summary>
    /// 4.19's FPrimitiveUniformShaderParameters (PrimitiveUniformShaderParameters.h:14-33) - see
    /// ViewRowsUE4_19's own summary for how this differs from the later engine's PrimitiveRows table
    /// above: no motion-vector fields, no LightmapDataIndex/SingleCaptureIndex, and
    /// InvNonUniformScale/LocalToWorldDeterminantSign are separate fields rather than one combined
    /// "InvNonUniformScaleAndDeterminantSign" vector.
    /// </summary>
    public static readonly Dictionary<int, string?[]> PrimitiveRowsUE4_19 = new()
    {
        [0] = new string?[] { "LocalToWorld", "LocalToWorld", "LocalToWorld", "LocalToWorld" },
        [1] = new string?[] { "LocalToWorld", "LocalToWorld", "LocalToWorld", "LocalToWorld" },
        [2] = new string?[] { "LocalToWorld", "LocalToWorld", "LocalToWorld", "LocalToWorld" },
        [3] = new string?[] { "LocalToWorld", "LocalToWorld", "LocalToWorld", "LocalToWorld" },
        [4] = new string?[] { "WorldToLocal", "WorldToLocal", "WorldToLocal", "WorldToLocal" },
        [5] = new string?[] { "WorldToLocal", "WorldToLocal", "WorldToLocal", "WorldToLocal" },
        [6] = new string?[] { "WorldToLocal", "WorldToLocal", "WorldToLocal", "WorldToLocal" },
        [7] = new string?[] { "WorldToLocal", "WorldToLocal", "WorldToLocal", "WorldToLocal" },
        [8] = new string?[] { "ObjectWorldPositionAndRadius", "ObjectWorldPositionAndRadius", "ObjectWorldPositionAndRadius", "ObjectWorldPositionAndRadius" },
        [9] = new string?[] { "ObjectBounds", "ObjectBounds", "ObjectBounds", "LocalToWorldDeterminantSign" },
        [10] = new string?[] { "ActorWorldPosition", "ActorWorldPosition", "ActorWorldPosition", "DecalReceiverMask" },
        [11] = new string?[] { "PerObjectGBufferData", "UseSingleSampleShadowFromStationaryLights", "UseVolumetricLightmapShadowFromStationaryLights", "UseEditorDepthTest" },
        [12] = new string?[] { "ObjectOrientation", "ObjectOrientation", "ObjectOrientation", "ObjectOrientation" },
        [13] = new string?[] { "NonUniformScale", "NonUniformScale", "NonUniformScale", "NonUniformScale" },
        [14] = new string?[] { "InvNonUniformScale", "InvNonUniformScale", "InvNonUniformScale", "InvNonUniformScale" },
        [15] = new string?[] { "LocalObjectBoundsMin", "LocalObjectBoundsMin", "LocalObjectBoundsMin", null },
        [16] = new string?[] { "LocalObjectBoundsMax", "LocalObjectBoundsMax", "LocalObjectBoundsMax", "LightingChannelMask" },
        [17] = new string?[] { "LpvBiasMultiplier", null, null, null },
    };
}
