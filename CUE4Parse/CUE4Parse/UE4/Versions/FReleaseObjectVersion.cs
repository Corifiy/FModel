...
public static class FReleaseObjectVersion
{
    ...
    public static Type Get(FArchive Ar)
    {
        ...
        return Ar.Game switch
        {
            ...
            // GAME_UE4_19 covers a wide range of early Fortnite patches (e.g. 1.10) whose internal
            // engine branch predates MaterialLayersParameterSerializationRefactor - guessing
            // AddSkeletalMeshSectionDisable here (as later UE4.19 titles would need) makes
            // FStaticParameterSet read a MaterialLayersParameters array that isn't actually present
            // and misparse. Use RenameNoTwistToAllowTwistInTwoBoneIK (same as the pre-4.19 bucket)
            // for the whole GAME_UE4_19 range instead.
            < EGame.GAME_UE4_20 => Type.RenameNoTwistToAllowTwistInTwoBoneIK,
