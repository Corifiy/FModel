...
public static class FRenderingObjectVersion
{
    ...
    public static Type Get(FArchive Ar)
    {
        ...
        return Ar.Game switch
        {
            ...
            // engine branch predates MaterialAttributeLayerParameters - guessing ShaderPermutationId
            // here (as later UE4.19 titles would need) makes UMaterialInstance's static-parameter-set
            // format detection pick the wrong (post-refactor) branch and misparse. Use VolumetricLightmaps
            // (same as the pre-4.19 bucket) for the whole GAME_UE4_19 range instead.
            < EGame.GAME_UE4_20 => Type.VolumetricLightmaps,
